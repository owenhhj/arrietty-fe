...
export default function AdminBulletinForm(
  ...
  return (
    <Modal isOpen={isOpen} style={modalStyles}>
      <div className={"admin-bulletin-form card"}>
        <div className={"admin-bulletin-form-container"}>
          <Input identifier={"title"} type={"text"} prompt={"Title"} defaultValue={title} inputSize={"large"} onChange={handleFormInputChange}/>
          <Input identifier={"content"} type={"text"} prompt={"Content"} defaultValue={content} inputSize={"extra-large"} onChange={handleFormInputChange}/>
        </div>
